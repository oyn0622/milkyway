...
<body style="font-family: 'Noto Sans KR', sans-serif;">
	...
	<div style="position: static;top:0px;width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/gangnamgu/background01.jpg" width="700" height="984">
	</div>
    
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/gangnamgu/background02.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/gangnamgu/background03.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/gangnamgu/background04.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/gangnamgu/background05.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/gangnamgu/background06.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/gangnamgu/background07.jpg" width="700" height="984">
	</div>

	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/gangnamgu/background08.jpg" width="700" height="984">
		<span class="point" style="top: 348px;left: 170px;height: 17px;width: 42px;" id="종부세" onclick="openTooltip(this)"></span>
		<span class="point" style="top: 348px;left: 314px;height: 17px;width: 42px;" id="공시가" onclick="openTooltip(this)"></span>
		<span class="point" style="top: 435px;left: 148px;height: 17px;width: 68px;" id="세부담 상한" onclick="openTooltip(this)"></span>
        <span class="point" style="top: 455px;left: 98px;height: 17px;width: 100px;" id="공정시장가액비율" onclick="openTooltip(this)"></span>
		<span class="point" style="top: 476px;left: 98px;height: 17px;width: 76px;" id="조정지역대상" onclick="openTooltip(this)"></span>
		<span class="point" style="top: 597px;left: 137px;height: 17px;width: 80px;" id="지구단위계획" onclick="openTooltip(this)"></span>
	...
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/gangnamgu/background09.jpg" width="700" height="984">
	</div>
	...
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/gangnamgu/background11.jpg" width="700" height="984">
	</div>
	</div>
