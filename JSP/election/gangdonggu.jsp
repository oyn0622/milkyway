...
<body style="font-family: 'Noto Sans KR', sans-serif;">
	...
	<div style="position: static;top:0px;width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/gangdonggu/강동구갑_진선미_선거공보_1.jpg" width="700" height="984">
	</div>
    
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/gangdonggu/강동구갑_진선미_선거공보_2.jpg" width="700" height="984">
	</div>
	...
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
        <img src="${contextPath }/resources/image/gangdonggu/강동구갑_진선미_선거공보_4.jpg" width="700" height="984">
    </div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
        <img src="${contextPath }/resources/image/gangdonggu/강동구갑_진선미_선거공보_5.jpg" width="700" height="984">
		<span class="point" style="top:300px;left: 407px;height: 21px;width:80px;" id="클러스터화" onclick="openTooltip(this)"></span>
		<span class="point" style="top:351px;left: 385px;height: 21px;width:142px;" id="아파트 품질검사제도" onclick="openTooltip(this)"></span>
		<span class="point" style="top:478px;left: 342px;height: 21px;width:62px;" id="행복학교" onclick="openTooltip(this)"></span>
	...
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
        <img src="${contextPath }/resources/image/gangdonggu/강동구갑_진선미_선거공보_7.jpg" width="700" height="984">
		<span class="point" style="top:298px;left: 140px;height: 21px;width:48px;" id="저류지" onclick="openTooltip(this)"></span>
		<span class="point" style="top:469px;left: 154px;height: 21px;width:89px;" id="가로정비사업" onclick="openTooltip(this)"></span>
		<span class="point" style="top:517px;left: 189px;height: 21px;width:93px;" id="수직형 리프트" onclick="openTooltip(this)"></span>
		<span class="point" style="top:640px;left: 130px;height: 21px;width:90px;" id="첨단복합청사" onclick="openTooltip(this)"></span>
		<span class="point" style="top:736px;left: 235px;height: 21px;width:196px;" id="저층주거지 주거환경개선사업" onclick="openTooltip(this)"></span>
    </div>

	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/gangdonggu/강동구갑_진선미_선거공보_8.jpg" width="700" height="984">
    </div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
        <img src="${contextPath }/resources/image/gangdonggu/강동구갑_진선미_선거공보_9.jpg" width="700" height="984">
        <span class="point" style="top:470px;left: 358px;height: 19px;width:204px;" id="생애주기 맞춤형 사회안전망" onclick="openTooltip(this)"></span>

    </div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
        <img src="${contextPath }/resources/image/gangdonggu/강동구갑_진선미_선거공보_10.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/gangdonggu/강동구갑_진선미_선거공보_11.jpg" width="700" height="984">
	</div>
	</div>
