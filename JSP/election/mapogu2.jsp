...
<body style="font-family: 'Noto Sans KR', sans-serif;">
	...
	<div style="position:static;top:0px;width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/mapogu2/background01.jpg" width="700" height="984">
	</div>
    
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/mapogu2/background02.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/mapogu2/background03.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/mapogu2/background04.jpg" width="700" height="984">
		<span class="point" style="top: 388px;left: 441px;height:16px;width: 43px;" id="종상향" onclick="openTooltip(this)"></span>
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/mapogu2/background05.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/mapogu2/background06.jpg" width="700" height="984">

	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/mapogu2/background07.jpg" width="700" height="984">
		<span class="point" style="top: 228px;left: 537px;height:16px;width: 101px;" id="마포하우징 조성" onclick="openTooltip(this)"></span>
		<span class="point" style="top: 331px;left: 62px;height:16px;width: 179px;" id="성미산 명품생태공원 재구조화" onclick="openTooltip(this)"></span>
	...
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/mapogu2/background08.jpg" width="700" height="984">
		<span class="point" style="top: 434px;left: 380px;height:16px;width: 253px;" id="경의선숲길공원 물길 조성" onclick="openTooltip(this)"></span>
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/mapogu2/background09.jpg" width="700" height="984">
		<span class="point" style="top: 566px;left: 116px;height: 20px;width: 213px;" id="스마트 여성안심 통합네트워크" onclick="openTooltip(this)"></span>
		<span class="point" style="top: 707px;left: 189px;height: 20px;width: 105px;" id="일자리체인지업" onclick="openTooltip(this)"></span>
	...
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/mapogu2/background10.jpg" width="700" height="984">
	    
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/mapogu2/background11.jpg" width="700" height="984">
	</div>
	</div>
