...
<body style="font-family: 'Noto Sans KR', sans-serif;">
	...
	<h2 style="text-align: center;margin-top:-0.5%">선거공보물의 저작권은 해당 국회의원에게 있습니다.</h2>
		<div style="position: static;top:0px;width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(45%);">
			<img src="${contextPath }/resources/image/songpagu3/20200415_송파구병_남인순_선거공보_1.jpg" width="809" height="1104">
		</div>
		
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(45%);">
			<img src="${contextPath }/resources/image/songpagu3/20200415_송파구병_남인순_선거공보_2.jpg" width="809" height="1104">
		</div>
		
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(45%);">
			<img src="${contextPath }/resources/image/songpagu3/20200415_송파구병_남인순_선거공보_3.jpg" width="809" height="1104">
		</div>
		
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(45%);">
			<img src="${contextPath }/resources/image/songpagu3/20200415_송파구병_남인순_선거공보_4.jpg" width="809" height="1104">
		...
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(45%);">
			<img src="${contextPath }/resources/image/songpagu3/20200415_송파구병_남인순_선거공보_7.jpg" width="809" height="1104">
			<span class="point" style="top: 567px;left: 545px;height: 14px;width: 66px;" id="스마트시티" onclick="openTooltip(this)"></span>
			<span class="point" style="top: 616px;left: 408px;height: 14px;width: 91px;" id="전선지중화사업" onclick="openTooltip(this)"></span>
			<span class="point" style="top: 715px;left: 540px;height: 14px;width: 58px;" id="자족기능" onclick="openTooltip(this)"></span>
			<span class="point" style="top: 824px;left: 416px;height: 14px;width: 80px;" id="스페이스살림" onclick="openTooltip(this)"></span>
			<span class="point" style="top: 824px;left: 541px;height: 14px;width: 69px;" id="인생이모작" onclick="openTooltip(this)"></span>
			<span class="point" style="top: 897px;left: 311px;height: 14px;width: 109px;" id="장지차고지 입체화" onclick="openTooltip(this)"></span>
		</div>
	
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(45%);">
			<img src="${contextPath }/resources/image/songpagu3/20200415_송파구병_남인순_선거공보_8.jpg" width="809" height="1104">
			<span class="point" style="top: 889px;left: 424px;height: 14px;width: 58px;" id="과밀학급" onclick="openTooltip(this)"></span>
		</div>
		
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(45%);">
			<img src="${contextPath }/resources/image/songpagu3/20200415_송파구병_남인순_선거공보_9.jpg" width="809" height="1104">
		</div>
		
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(45%);">
			<img src="${contextPath }/resources/image/songpagu3/20200415_송파구병_남인순_선거공보_10.jpg" width="809" height="1104">

		</div>
		
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(45%);">
			<img src="${contextPath }/resources/image/songpagu3/20200415_송파구병_남인순_선거공보_11.jpg" width="809" height="1104">
		</div>
