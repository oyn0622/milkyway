...
<body style="font-family: 'Noto Sans KR', sans-serif;">
	...
	<h2 style="text-align: center;margin-top:-0.5%">선거공보물의 저작권은 해당 국회의원에게 있습니다.</h2>
		<div style="position: static;top:0px;width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(46%);">
			<img src="${contextPath }/resources/image/geumcheongu/금천구_최기상_선거공보_1.jpg" width="809" height="1104">
		</div>
		
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(46%);">
			<img src="${contextPath }/resources/image/geumcheongu/금천구_최기상_선거공보_2.jpg" width="809" height="1104">
		</div>
		
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(46%);">
			<img src="${contextPath }/resources/image/geumcheongu/금천구_최기상_선거공보_3.jpg" width="809" height="1104">
		</div>
		
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(46%);">
			<img src="${contextPath }/resources/image/geumcheongu/금천구_최기상_선거공보_4.jpg" width="809" height="1104">
		</div>
		
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(46%);">
			<img src="${contextPath }/resources/image/geumcheongu/금천구_최기상_선거공보_5.jpg" width="809" height="1104">
			<span class="point" style="top: 630px;left: 296px;height:21px;width: 118px;" id="법관독립위원회" onclick="openTooltip(this)"></span>
			<span class="point" style="top: 707px;left: 345px;height:21px;width: 58px;" id="공판부" onclick="openTooltip(this)"></span>
			<span class="point" style="top: 950px;left: 670px;height:21px;width: 88px;" id="공판중심주의" onclick="openTooltip(this)"></span>
			<span class="point" style="top: 972px;left:299px;height:21px;width:83px;" id="직접심리주의" onclick="openTooltip(this)"></span>
			<span class="point" style="top: 972px;left:386px;height:21px;width:83px;" id="구두변론주의" onclick="openTooltip(this)"></span>
		</div>
		
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(46%);">
			<img src="${contextPath }/resources/image/geumcheongu/금천구_최기상_선거공보_6.jpg" width="809" height="1104">
			<span class="point" style="top: 429px;left: 360px;height:21px;width: 118px;" id="소비자 집단소송제" onclick="openTooltip(this)"></span>
			<span class="point" style="top: 606px;left: 510px;height:21px;width: 60px;" id="세제지원" onclick="openTooltip(this)"></span>
		...
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(46%);">
			<img src="${contextPath }/resources/image/geumcheongu/금천구_최기상_선거공보_9.jpg"width="809" height="1104">
		</div>
		
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(46%);">
			<img src="${contextPath }/resources/image/geumcheongu/금천구_최기상_선거공보_10.jpg" width="809" height="1104">
		</div>
		
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(46%);">
			<img src="${contextPath }/resources/image/geumcheongu/금천구_최기상_선거공보_11.jpg"width="809" height="1104">
		</div>
