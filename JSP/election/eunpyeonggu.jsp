...
<body style="font-family: 'Noto Sans KR', sans-serif;">
	...
	<h2 style="text-align: center;margin-top:-0.5%">선거공보물의 저작권은 해당 국회의원에게 있습니다.</h2>
		<div style="position: static;top:0px;width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(46%);">
			<img src="${contextPath }/resources/image/eunpyeonggu/은평구갑_박주민_선거공보_1.jpg" width="809" height="1104">
		</div>
		
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(46%);">
			<img src="${contextPath }/resources/image/eunpyeonggu/은평구갑_박주민_선거공보_2.jpg" width="809" height="1104">
		</div>
		...
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(46%);">
			<img src="${contextPath }/resources/image/eunpyeonggu/은평구갑_박주민_선거공보_8.jpg" width="809" height="1104">
			<span class="point" style="top: 1044px;left:432px;height:21px;width:104px;" id="거점형 키움타운" onclick="openTooltip(this)"></span>
		</div>
		
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(46%);">
			<img src="${contextPath }/resources/image/eunpyeonggu/은평구갑_박주민_선거공보_9.jpg"width="809" height="1104">
		</div>
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(46%);">
			<img src="${contextPath }/resources/image/eunpyeonggu/은평구갑_박주민_선거공보_10.jpg"width="809" height="1104">
		</div>
		<div style="width:809px;height:1104px;overflow:hidden;border:1.5px solid lightgray;transform:translate(46%);">
			<img src="${contextPath }/resources/image/eunpyeonggu/은평구갑_박주민_선거공보_11.jpg"width="809" height="1104">
		</div>
