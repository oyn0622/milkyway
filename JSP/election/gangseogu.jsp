...
<body style="font-family: 'Noto Sans KR', sans-serif;">
	...
	<div style="position:static;top:0px;width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/gangseogu/강서구갑_강선우_선거공보_1.jpg" width="700" height="984">
	</div>
    
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/gangseogu/강서구갑_강선우_선거공보_2.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
        <img src="${contextPath }/resources/image/gangseogu/강서구갑_강선우_선거공보_3.jpg" width="700" height="984">
    </div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
        <img src="${contextPath }/resources/image/gangseogu/강서구갑_강선우_선거공보_4.jpg" width="700" height="984">
    </div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
        <img src="${contextPath }/resources/image/gangseogu/강서구갑_강선우_선거공보_5.jpg" width="700" height="984">
		<span class="point" style="top:330px;left: 80px;height: 21px;width:75px;" id="국민소환제" onclick="openTooltip(this)"></span>
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
        <img src="${contextPath }/resources/image/gangseogu/강서구갑_강선우_선거공보_6.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
        <img src="${contextPath }/resources/image/gangseogu/강서구갑_강선우_선거공보_7.jpg" width="700" height="984">
		<span class="point" style="top:232px;left: 33px;height: 29px;width:140px;" id="감염병 대응체계" onclick="openTooltip(this)"></span>
		<span class="point" style="top:319px;left: 178px;height: 18px;width:55px;" id="복수차관제" onclick="openTooltip(this)"></span>
		<span class="point" style="top:572px;left: 46px;height: 18px;width:67px;" id="다중이용업소" onclick="openTooltip(this)"></span>
		<span class="point" style="top:671px;left: 183px;height: 18px;width:57px;" id="옐로우카펫" onclick="openTooltip(this)"></span>
        <span class="point" style="top:729px;left: 47px;height: 18px;width:110px;" id="교통안전계정 별도 신설" onclick="openTooltip(this)"></span>
        <span class="point" style="top:900px;left: 47px;height: 18px;width:152px;" id="스마트 여성 안심 통합 네트워크" onclick="openTooltip(this)"></span>
    </div>

	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
        <img src="${contextPath }/resources/image/gangseogu/강서구갑_강선우_선거공보_8.jpg" width="700" height="984">
        <span class="point" style="top:338px;left: 365px;height: 19px;width:110px;" id="상권 르네상스 프로젝트" onclick="openTooltip(this)"></span>
		<span class="point" style="top:873px;left: 554px;height: 19px;width:109px;" id="온종일 돌봄 체계" onclick="openTooltip(this)"></span>
    </div>
	...
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/gangseogu/강서구갑_강선우_선거공보_11.jpg" width="700" height="984">
	</div>
	</div>
