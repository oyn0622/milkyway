...
<body style="font-family: 'Noto Sans KR', sans-serif;">
	...
	<div style="position:static;top:0px;width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/songpagu2/송파구을_배현진_선거공보_1.jpg" width="700" height="984">
	</div>
    
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/songpagu2/송파구을_배현진_선거공보_2.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/songpagu2/송파구을_배현진_선거공보_3.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/songpagu2/송파구을_배현진_선거공보_4.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/songpagu2/송파구을_배현진_선거공보_5.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/songpagu2/송파구을_배현진_선거공보_6.jpg" width="700" height="984">
	</div>
	...
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		...
		<div class="blinkBox" style="top: 535px;left:93px;" onclick="openNav('국가 재난시 긴급 유급 돌봄 휴가제 도입')" >
			<img src="${contextPath }/resources/image/logo/search.png" width="18" class="blink">
		</div>
	</div>
	...
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		...
		<div class="blinkBox" style="top: 655px;left:448px;" onclick="openNav('석촌호수~ 백제고분 명소화')" >
			<img src="${contextPath }/resources/image/logo/search.png" width="26" class="blink">
		</div>
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/songpagu2/송파구을_배현진_선거공보_10.jpg" width="700" height="984">
        <span class="point" style="top: 452px;left: 130px;height:26px;width: 130px;" id="N번방 방지법" onclick="openTooltip(this)"></span>
		<span class="point" style="top: 563px;left: 130px;height:26px;width: 309px;" id="맞춤형 범죄 예방 디자인(CPTED)" onclick="openTooltip(this)"></span>   
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/songpagu2/송파구을_배현진_선거공보_11.jpg" width="700" height="984">
	</div>
	</div>
