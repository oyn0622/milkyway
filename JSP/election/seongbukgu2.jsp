...
<body style="font-family: 'Noto Sans KR', sans-serif;">
	...
	<div class="contentslining">
	    ...
	    <img src="${contextPath }/resources/image/seongbukgu2/20200415_성북구을_기동민_선거공보_1.jpg" width="700" height="984">
	</div>
    
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/seongbukgu2/20200415_성북구을_기동민_선거공보_2.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/seongbukgu2/20200415_성북구을_기동민_선거공보_3.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/seongbukgu2/20200415_성북구을_기동민_선거공보_4.jpg" width="700" height="984">
	...
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/seongbukgu2/20200415_성북구을_기동민_선거공보_5.jpg" width="700" height="984">
		<span class="point" style="top: 411px;left: 380px;height: 26px;width: 104px;" id="돌봄공동체" onclick="openTooltip(this)"></span>
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/seongbukgu2/20200415_성북구을_기동민_선거공보_6.jpg" width="700" height="984">
	...
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/seongbukgu2/20200415_성북구을_기동민_선거공보_7.jpg" width="700" height="984">
		<div class="blinkBox" style="top: 279px;left:131px;" onclick="openNav('1. 동북권 교통의 요지로 떠오르는 성북')" >
	...
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/seongbukgu2/20200415_성북구을_기동민_선거공보_10.jpg" width="700" height="984">
	...
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/seongbukgu2/20200415_성북구을_기동민_선거공보_11.jpg" width="700" height="984">
	</div>
