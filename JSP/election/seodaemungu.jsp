...
<body style="font-family: 'Noto Sans KR', sans-serif;">
	...
	<div style="position:static;top:0px;width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/seodaemungu/background01.jpg" width="700" height="984">
	</div>
    
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/seodaemungu/background02.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/seodaemungu/background03.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/seodaemungu/background04.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/seodaemungu/background05.jpg" width="700" height="984">
	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/seodaemungu/background06.jpg" width="700" height="984">

	</div>
	
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/seodaemungu/background07.jpg" width="700" height="984">
		<span class="point" style="top: 239px;left: 105px;height:16px;width: 76px;" id="고가도로 철거" onclick="openTooltip(this)"></span>
		<span class="point" style="top: 239px;left: 220px;height:16px;width: 73px;" id="고가도로 철거" onclick="openTooltip(this)"></span>
	</div>

	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/seodaemungu/background08.jpg" width="700" height="984">
		<span class="point" style="top: 101px;left: 142px;height:16px;width: 29px;" id="개축" onclick="openTooltip(this)"></span>
		<span class="point" style="top: 345px;left: 416px;height:16px;width: 43px;" id="옐로카펫" onclick="openTooltip(this)"></span>
		<span class="point" style="top: 409px;left: 240px;height: 21px;width: 55px;" id="보훈회관" onclick="openTooltip(this)"></span>
	...
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
		<img src="${contextPath }/resources/image/seodaemungu/background10.jpg" width="700" height="984">
	...
	<div style="width:700px;height:984px;overflow:hidden;border:1.5px solid lightgray;transform:translate(58%);">
	    <img src="${contextPath }/resources/image/seodaemungu/background11.jpg" width="700" height="984">
	</div>
	</div>
