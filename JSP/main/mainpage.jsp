        ...
        <div id="ex1" class="modal">
            <div class="slideshow-container">
                ...
                <div class="mySlides fade">
                  <img src="사이트이용안내서/메인페이지&선거공보물/1.png" style="width:100%;height:61%;">
                  
                </div>
                
                <div class="mySlides fade">
                  <img src="사이트이용안내서/메인페이지&선거공보물/2.png" style="width:100%;height: 61%;">
                </div>
                
                <div class="mySlides fade">
                  <img src="사이트이용안내서/메인페이지&선거공보물/3.png" style="width:100%;height: 61%;">
                </div>
                 <div class="mySlides fade">
                  <img src="사이트이용안내서/메인페이지&선거공보물/4.png" style="width:100%;height: 61%;">
                </div>               
                <div class="mySlides fade">
                    <img src="사이트이용안내서/메인페이지&선거공보물/5.png" style="width:100%;height: 61%;">
                </div>
                <div class="mySlides fade">
                    <img src="사이트이용안내서/메인페이지&선거공보물/6.png" style="width:100%;height: 61%;">
                </div> 
                  
                  <div class="mySlides fade">
                    <img src="사이트이용안내서/메인페이지&선거공보물/7.png" style="width:100%;height: 61%;">
                  </div>
                   <div class="mySlides fade">
                    <img src="사이트이용안내서/메인페이지&선거공보물/8.png" style="width:100%;height: 61%;">
                  </div>              
                  <div class="mySlides fade">
                    <img src="사이트이용안내서/메인페이지&선거공보물/9.png" style="width:100%;height:61%;">
                  </div>      
    ...
    <span class="map">
        ...
        <div id="open-moda3" class="modal-window">
            ...
            <div class="candidates">
                ...
                <a href="${contextPath }/election/gangseogu2">
                    <img src="${contextPath}/resources/image/id_card/진성준.png"></img>
                </a>
                <a href="${contextPath }/election/gangseogu3">
                    <img src="${contextPath}/resources/image/id_card/한정애.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        <div id="open-moda4" class="modal-window">
            ...
            <div class="candidates">
                ...
                <a href="${contextPath }/election/gangbukgu2"style="margin-left:10px;">
                    <img src="${contextPath}/resources/image/id_card/박용진.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        ...
        <div id="open-moda6" class="modal-window">
            ...
            <div class="candidates">
                ...
                <a href="${contextPath }/election/nowongu2">
                    <img src="${contextPath}/resources/image/id_card/우원식.png"></img>
                </a>
                <a href="${contextPath }/election/nowongu3">
                    <img src="${contextPath}/resources/image/id_card/김성환.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        <div id="open-moda7" class="modal-window">
            ...
            <div class="candidates">
                ...
                <a href="${contextPath }/election/dongjakgu2" style="margin-left:10px;">
                    <img src="${contextPath}/resources/image/id_card/이수진.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        <div id="open-moda8" class="modal-window">
            ...
            <div class="candidates">
                ...
                <a href="${contextPath }/election/yeongdeungpogu2" style="margin-left:10px;">
                    <img src="${contextPath}/resources/image/id_card/김민석.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        <div id="open-moda9" class="modal-window">
            ...
            <div class="candidates">
                ...
                <a href="${contextPath }/election/songpagu2">
                    <img src="${contextPath}/resources/image/id_card/배현진.png"></img>
                </a>
                <a href="${contextPath }/election/songpagu3">
                    <img src="${contextPath}/resources/image/id_card/남인순.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        <div id="open-moda10" class="modal-window">
            ...
            <div class="candidates">
                ...
                <a href="${contextPath }/election/mapogu2" style="margin-left:10px;">
                    <img src="${contextPath}/resources/image/id_card/정청래.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        <div id="open-moda11" class="modal-window">
            ...
            <div class="candidates">
                ...
                <a href="${contextPath }/election/dongdaemungu2" style="margin-left:10px;">
                    <img src="${contextPath}/resources/image/id_card/장경태.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        <div id="open-moda12" class="modal-window">
            ...
            <div class="candidates">
                ...
                <a href="${contextPath }/election/seodaemungu2" style="margin-left:10px;">
                    <img src="${contextPath}/resources/image/id_card/김영호.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        <div id="open-moda13" class="modal-window">
            ...
            <div class="candidates">
                ...
                <a href="${contextPath }/election/gwanakgu2" style="margin-left:10px;">
                    <img src="${contextPath}/resources/image/id_card/정태호.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        <div id="open-moda14" class="modal-window">
            ...
            <div class="candidates">
                ...
                <a href="${contextPath }/election/seochogu2" style="margin-left:10px;">
                    <img src="${contextPath}/resources/image/id_card/박성중.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        <div id="open-moda15" class="modal-window">
            ...
            <div class="candidates">
                ...
                <a href="${contextPath }/election/gurogu2" style="margin-left:10px;">
                    <img src="${contextPath}/resources/image/id_card/윤건영.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        <div id="open-moda16" class="modal-window">
            ...
            <div class="candidates">
                ...
                <a href="${contextPath }/election/dobonggu2" style="margin-left:10px;">
                    <img src="${contextPath}/resources/image/id_card/오기형.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        <div id="open-moda17" class="modal-window">
            ...
            <div class="candidates"  >
                ...
                <a href="${contextPath }/election/gwangjingu2" style="margin-left:10px;">
                    <img src="${contextPath}/resources/image/id_card/고민정.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        <div id="open-moda18" class="modal-window">
            ...
            <div class="candidates"  >
                ...
                <a href="${contextPath }/election/gangdonggu2" style="margin-left:10px;">
                    <img src="${contextPath}/resources/image/id_card/이해식.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        <div id="open-moda19" class="modal-window">
            ...
            <div class="candidates">
                ...
                <a href="${contextPath }/election/gangnamgu2">
                    <img src="${contextPath}/resources/image/id_card/박진.png"></img>
                </a>                
                <a href="${contextPath }/election/gangnamgu3">
                    <img src="${contextPath}/resources/image/id_card/유경준.png"></img>
                </a>
        ...
        <div id="open-moda20" class="modal-window">
            ...
            <div class="candidates"  >
                ...
                <a href="${contextPath }/election/yangcheongu2" style="margin-left:10px;">
                    <img src="${contextPath}/resources/image/id_card/이용선.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        <div id="open-moda21" class="modal-window">
            ...
            <div class="candidates"  >
                ...
                <a href="${contextPath }/election/seongbukgu2" style="margin-left:10px;">
                    <img src="${contextPath}/resources/image/id_card/기동민.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        <div id="open-moda22" class="modal-window">
            ...
            <div class="candidates"  >
                ...
                <a href="${contextPath }/election/eunpyeonggu2" style="margin-left:10px;">
                    <img src="${contextPath}/resources/image/id_card/강병원.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        <div id="open-moda23" class="modal-window">
            ...
            <div class="candidates"  >
                ...
                <a href="${contextPath }/election/jungnanggu2" style="margin-left:10px;">
                    <img src="${contextPath}/resources/image/id_card/박홍근.png"></img>
                </a>
            </div>
        </div>
        <!-- 팝업창 -->
        <div id="open-moda24" class="modal-window">
            ...
            <div class="candidates"  >
                ...
                <a href="${contextPath }/election/junggu_seongdonggu2" style="margin-left:10px;">
                    <img src="${contextPath}/resources/image/id_card/박성준.png"></img>
                </a>
            </div>
        </div>
        <!-- 지도 -->
        <svg xmlns="http://www.w3.org/2000/svg" version="1.2" baseProfile="tiny" viewBox="0 16 309 300" stroke-linecap="round" stroke-linejoin="round"><defs xmlns="http://www.w3.org/2000/svg">    <filter id="outline">        <feMorphology in="SourceAlpha" result="morp" operator="dilate" radius="1"></feMorphology>        <feFlood flood-color="#000000" flood-opacity="0.7" result="flood"></feFlood>        <feComposite in="flood" in2="morp" operator="in" result="outline"></feComposite>        <feMerge>            <feMergeNode in="outline"></feMergeNode>            <feMergeNode in="SourceGraphic"></feMergeNode>        </feMerge>    </filter></defs>
            <g id="서울특별시-sig-main">
